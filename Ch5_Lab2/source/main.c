...
int main()
{
	...
	int choice = 0, studentsGrades[students][exams] = { { 77, 68, 86, 73 },{ 96, 87, 89, 78 },{ 70, 90, 86, 81 } };
...
{
	printf("\n\tEnter a choice:\n"
		"\t  0 Print the array of grrades\n"
		"\t  1 Find the minimum grrade\n"
		"\t  2 Find the maximum grrade\n"
